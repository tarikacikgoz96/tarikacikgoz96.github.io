...
# Hoşgeldiniz
Bu site Tarık AÇIKGÖZ'ün kişisel web sitesi / portfolyosudur.
Sitede kariyerim boyunca deneyimlerimi sizlerle paylaşacağım.

Bu sitede özetle şu içerikler mevcuttur:
- Profile  : Kişisel tanıtım (Tecrübeler, yetkinlikler)
- Projects : Yaptığım işlerin / projelerin tanıtımı
- Articles : Yazdığım makaleler
- Dev Notes: Faydalı geliştirici notları ve kod parçaları
